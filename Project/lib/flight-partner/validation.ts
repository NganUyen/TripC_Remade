...
export const createRouteSchema = z.object({
  ...
  destination: z.string().length(3, 'Destination airport code must be 3 characters'),
...
export const createPricingRuleSchema = z.object({
  ...
  rule_type: z.enum(['base', 'seasonal', 'demand', 'advance_booking', 'day_of_week']),
  route_id: z.string().uuid('Invalid route ID').optional(),
  flight_class: z.enum(['economy', 'premium_economy', 'business', 'first']).optional(),
...
export const updateBookingStatusSchema = z.object({
  status: z.enum(['pending', 'confirmed', 'checked_in', 'boarded', 'completed', 'cancelled', 'no_show']),
...
export const revenueReportFiltersSchema = z.object({
  ...
  flight_id: z.string().uuid().optional(),
  booking_class: z.enum(['economy', 'premium_economy', 'business', 'first']).optional(),
