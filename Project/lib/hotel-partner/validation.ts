...
const baseRoomSchema = z.object({
  ...
  max_adults: z
    ...
    .max(8, "Max adults must be at most 8"),
  max_children: z
    .number()
    .int()
    .min(0, "Max children cannot be negative")
    .max(4, "Max children must be at most 4"),
  bed_configurations: z
    .array(bedConfigSchema)
    .min(1, "At least one bed configuration is required"),
  size_sqm: z
    .number()
    .min(10, "Size must be at least 10 sqm")
    .max(500, "Size must be at most 500 sqm")
    .optional(),
...
export const createRateSchema = z
  .object({
    ...
    price_cents: z
      .number()
      .int()
      .min(1000, "Price must be at least $10 (1000 cents)")
      .max(100000000, "Price cannot exceed $1,000,000"),
    available_rooms: z
      .number()
      .int()
      .min(0, "Available rooms cannot be negative")
      .max(100, "Available rooms cannot exceed 100"),
    min_nights: z
      .number()
      .int()
      .min(1, "Minimum nights must be at least 1")
      .max(30, "Minimum nights cannot exceed 30")
      .optional(),
    max_nights: z
      .number()
      .int()
      .min(1, "Maximum nights must be at least 1")
      .max(90, "Maximum nights cannot exceed 90")
      .optional(),
    cancellation_policy: z.enum([
      "flexible",
      "moderate",
...
export const createBookingSchema = z
  .object({
    ...
    rooms_count: z
      ...
      .max(10, "Cannot book more than 10 rooms"),
    adults_count: z
      .number()
      .int()
      .min(1, "Must have at least 1 adult")
      .max(16, "Too many adults"),
    children_count: z
      .number()
      .int()
      .min(0, "Children count cannot be negative")
      .max(8, "Too many children"),
...
export const cancelBookingSchema = z.object({
  ...
  refund_method: z
    .enum(["original_payment", "tcent", "bank_transfer"])
    .optional(),
});
