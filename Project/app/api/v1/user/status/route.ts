...
export async function GET() {
    try {
        ...
        if (error) {
            ...
            if (error.code === 'PGRST116') {
                ...
                const { data: newUser, error: createError } = await supabase
                    ...
                    .insert([{
                        clerk_id: userId,
                        email: 'user_' + userId.slice(-8) + '@example.com', // Placeholder: In a real app, you'd fetch email from Clerk API
                        name: 'New Traveller',
                ...
                return NextResponse.json({
                    ...
                    expiry_warning: 'No points expiring'
                })
            }
        ...
        return NextResponse.json({
            ...
            expiry_warning: '450 pts by Dec 31' // Mocked for now as per plan
        })
    } catch (err) {
