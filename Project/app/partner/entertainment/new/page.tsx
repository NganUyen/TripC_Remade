...
export default function NewEntertainmentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/partner/entertainment', {
                method: 'POST',
            ...
            if (res.ok) {
                ...
                alert(error.error || 'Failed to create entertainment')
            }
        } catch (error) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 mb-20">
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Create New Entertainment</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        name="title"
                        required
                        placeholder="e.g. Traditional Water Puppet Show"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="address"
                            name="address"
                            placeholder="e.g. 57B Dinh Tien Hoang"
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        id="description"
                        name="description"
                        placeholder="Describe the entertainment..."
                        className="h-32"
                ...
                <div className="pt-4 flex gap-4">
                    ...
                    <Button type="submit" disabled={loading} className="bg-pink-600 hover:bg-pink-700 text-white">
                        {loading ? 'Creating...' : 'Create Entertainment'}
                    </Button>
                </div>
            </form>
        </div>
