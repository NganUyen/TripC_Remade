    ...
    return (
        <div className="flex flex-col items-center gap-6 mb-4">
            ...
            <div className="flex items-center gap-3 p-1.5 bg-white dark:bg-white/5 rounded-full border border-border-subtle dark:border-white/10 shadow-sm">
                <div className="flex items-center gap-2 bg-primary px-5 py-2 rounded-full text-white">
                ...
                <div className="flex items-center gap-2 px-4 py-2 text-charcoal/40 dark:text-white/40">
