        ...
        <section className="bg-white dark:bg-[#18181b] rounded-[3rem] p-8 md:p-12 border border-slate-100 dark:border-zinc-800 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                    ...
                    <div key={i} className="flex gap-5 p-4 rounded-[2rem] bg-slate-50 dark:bg-zinc-800/50 hover:bg-white hover:shadow-xl dark:hover:bg-zinc-800 transition-all cursor-pointer group border border-transparent hover:border-slate-100 dark:hover:border-zinc-700">
