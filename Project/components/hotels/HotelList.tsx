...
import { Star, Wifi, Droplets, Utensils, Heart, ChevronRight, Share2, GitCompare, ArrowRightLeft, X, Check, Copy, Facebook, Twitter, Mail } from 'lucide-react'
                        ...
                        <div className="flex-1 flex flex-col pt-2 pb-1 pr-2 md:pt-2 md:pb-2 md:pr-2 h-full">
                            ...
                            <div className="flex justify-between items-start gap-4">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white leading-tight mb-1 group-hover:text-orange-500 transition-colors line-clamp-2 min-h-[3rem]">
                                        {hotel.name}
                                    </h3>
                                    <p className="text-sm text-slate-500 dark:text-slate-400 font-medium truncate">
                                        {hotel.location} • <span className="text-blue-500 hover:underline cursor-pointer">Map</span>
                                    </p>
                                </div>
                                ...
                                <div className="hidden md:flex flex-col items-end gap-2 shrink-0 w-[140px]">
                                    ...
                                    >
                                        <div className={`size-4 rounded-full border flex items-center justify-center transition-colors ${isSelected
                            ...
                            <div className="mt-auto flex items-end justify-between border-t border-slate-100 dark:border-slate-800/50 pt-4">
                                ...
                                <div className="flex flex-col items-end ml-auto w-full md:w-auto">
                                    ...
                                    <div className="h-5 mb-1 flex justify-end w-full">
                                        {hotel.priceOld ? (
                                            <span className="text-sm text-slate-400 line-through font-medium leading-none">US${hotel.priceOld}</span>
                                        ) : (
                                            <span className="opacity-0 text-sm">Placeholder</span> /* Keeps height consistent */
                                        )}
                                    </div>
                                    ...
                                    <Link
                                        ...
                                        className="w-full md:w-auto px-6 py-2.5 rounded-full bg-white dark:bg-transparent border-2 border-orange-500 text-orange-500 font-bold text-sm hover:bg-orange-500 hover:text-white transition-all flex items-center justify-center gap-2 group/btn min-w-[140px]"
                                    >
                                        View Deal
                    ...
                    >
                        <div className="max-w-5xl mx-auto bg-white dark:bg-slate-900 rounded-[2rem] shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] border border-slate-200 dark:border-slate-800 p-4 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    onClick={() => router.push(`/hotels/compare?ids=${selectedHotels.join(',')}`)}
