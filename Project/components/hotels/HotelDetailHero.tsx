...
const HERO_IMAGES = [
    "https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=2574&auto=format&fit=crop", // Pool/Ocean
    "https://images.unsplash.com/photo-1590490360182-c87295ecc056?q=80&w=2670&auto=format&fit=crop", // Luxury Room
    "https://images.unsplash.com/photo-1571896349842-68c47e90c885?q=80&w=2670&auto=format&fit=crop", // Evening/Architectural
    "https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2670&auto=format&fit=crop"  // Resort Vibes
]

export function HotelDetailHero() {
                    ...
                    >
                        <div>
                            ...
                            <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400 font-medium">
                                ...
                                <span className="w-1 h-1 bg-slate-400 rounded-full mx-1" />
                                <Link href="#" className="underline hover:text-orange-500">Show Map</Link>
                            </div>
                        </div>

                        <div className="flex items-center gap-4">
                            <div className="text-right hidden md:block">
                                <p className="text-sm font-bold text-slate-500 dark:text-slate-400">Excellent</p>
                                <p className="text-2xl font-black text-slate-900 dark:text-white">4.9</p>
                            </div>
                            <div className="w-14 h-14 bg-blue-600 rounded-2xl rounded-tr-sm flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-blue-500/30">
                                9.8
                            </div>
                        </div>
                    </motion.div>
