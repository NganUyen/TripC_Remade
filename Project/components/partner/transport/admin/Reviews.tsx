        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl self-start md:self-center">
                    <div className="px-4 py-2 bg-white dark:bg-slate-700 rounded-xl shadow-sm">
                        ...
                        <span className="ml-2 text-xs font-bold text-slate-500 uppercase tracking-widest">Phản hồi</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 text-white rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 text-center">
                        <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-4">Xếp hạng trung bình</p>
                ...
                <div className="lg:col-span-3 bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-xl font-bold text-slate-900 dark:text-white">Phân bổ đánh giá</h2>
                    </div>
            ...
            {loading ? (
                <div className="space-y-6">
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 border border-slate-200 dark:border-slate-800 animate-pulse">
                            ...
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
                                ...
                                {review.transport_routes && (
                                    <div className="flex items-center gap-2 px-6 py-3 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700">
                                        <span className="text-xs font-black uppercase tracking-tight text-slate-500">Chuyến:</span>
                                        <span className="text-sm font-black text-slate-900 dark:text-white">
                                            {(review.transport_routes as any).origin} → {(review.transport_routes as any).destination}
                                        </span>
                                    </div>
                                )}
                            </div>
                            ...
                            {review.response && (
                                <div className="bg-emerald-500/5 dark:bg-emerald-500/10 rounded-3xl p-8 mb-8 border border-emerald-500/10 relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <p className="text-xs font-black uppercase tracking-widest text-emerald-600 mb-2">Phản hồi từ bạn</p>
                                        <p className="text-slate-700 dark:text-slate-300 text-base leading-relaxed">{review.response}</p>
                                    </div>
                                </div>
                            )}
