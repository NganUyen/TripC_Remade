            ...
            <div className="min-h-[400px] p-4">
              {events.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
                          ...
                          <span className="px-2.5 py-0.5 bg-primary/10 text-primary rounded-full text-[10px] font-bold uppercase tracking-wider">
                            {getVehicleTypeLabel(event.type)} •{" "}
                            {event.vehicle_type}
                          </span>
                        </div>
                      </div>
                      <div className="text-right shrink-0">
                        <div className="flex items-center justify-end gap-1.5 mb-1">
                          ...
                          <span
                            className={`text-sm font-bold ${event.seats_available > 5 ? "text-green-600" : "text-amber-600"}`}
                          >
                ...
                <div className="flex flex-col items-center justify-center h-64 text-center">
                  ...
                  <p className="text-slate-500 dark:text-slate-400">
                    Không có lịch trình vận hành trong ngày{" "}
                    {formatDate(currentDate)}
                  </p>
                </div>
              )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">
                {
                  new Set(events.map((e) => `${e.origin}-${e.destination}`))
                    .size
                }
              </p>
            </div>
