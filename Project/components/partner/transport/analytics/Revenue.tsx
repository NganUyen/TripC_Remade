      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 animate-pulse"
            >
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mt-1">
                Dữ liệu hợp nhất thời gian thực
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-black tracking-tight">
                {formatCurrency(
                  data.revenueByDay[data.revenueByDay.length - 1]?.revenue || 0,
                )}
              </p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-2xl font-black tracking-tight">
                {data.avgTicketPrice > 0
                  ? Math.round(data.periodRevenue / data.avgTicketPrice)
                  : 0}
              </p>
