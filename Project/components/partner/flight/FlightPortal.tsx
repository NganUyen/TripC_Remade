...
type Section = 
    | 'dashboard'
    | 'flight-list' | 'flight-schedule'
    | 'route-list' | 'route-analytics'
    | 'pricing-rules' | 'dynamic-pricing'
    | 'booking-list' | 'passenger-management' | 'check-in-management'
    | 'analytics-dashboard' | 'revenue-report' | 'capacity-report' | 'performance-metrics'
