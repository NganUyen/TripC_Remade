...
export function DestinationCard({
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-subtle hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group border border-slate-100 dark:border-slate-700">
