                ...
                {CATEGORIES.map((cat, index) => (
                    <Link key={cat.id} href={cat.href}>
                        ...
                        >
                            ...
                            <span className="text-sm font-bold text-slate-600 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white transition-colors text-center">
                                {cat.name}
                            </span>
                        </motion.div>
                    </Link>
