...
export default function PendingBookingCard({ booking }: PendingBookingCardProps) {
    const [timeLeft] = useState('02:00:00'); // Dynamic calculation would be ideal in real app
    ...
    return (
        ...
        >
            ...
            {/* Price (if available in booking object, otherwise just action) & Action */}
            <div className="mt-auto pt-4 space-y-4">
                ...
                <button className="w-full py-3.5 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-slate-200/50 dark:shadow-none">
                    Complete Payment
                ...
                <div className="flex items-center justify-center gap-1.5 opacity-60">
                    ...
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-semibold uppercase tracking-wider">Secure Transaction</span>
                </div>
            </div>
        </motion.div>
    );
