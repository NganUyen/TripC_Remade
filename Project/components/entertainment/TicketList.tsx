            ...
            <div className="flex gap-6 overflow-x-auto pb-8 -mx-4 px-4 lg:-mx-12 lg:px-12 no-scrollbar snap-x">
                {HOT_TICKETS.map((ticket, i) => (
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                        className="snap-start shrink-0 w-[340px] md:w-[400px] flex bg-white dark:bg-[#18181b] rounded-2xl shadow-sm border border-slate-100 dark:border-zinc-800 overflow-hidden relative"
                    >
                        {/* Left: Image Area */}
