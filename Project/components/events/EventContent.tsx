    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-slate-900 dark:text-white text-lg md:text-xl font-medium leading-relaxed font-display italic">
          ...
          <span className="font-bold">Sunset Acoustic Set</span>. The food truck
          line peaks at 7 PM, so grab a bite before then!"
        </p>
      </motion.div>

      {/* Widgets Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Weather - Central Park, NY coordinates */}
        <WeatherForecast latitude={40.785091} longitude={-73.968285} />
        ...
        <div className="bg-purple-50 dark:bg-purple-900/10 rounded-[2rem] p-6 border border-purple-100 dark:border-purple-800/30">
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-center gap-3 text-sm font-medium text-slate-700 dark:text-slate-300">
              <div className="w-1.5 h-1.5 rounded-full bg-purple-400" /> QR
              Ticket (Digital or Print)
            </li>
            <li className="flex items-center gap-3 text-sm font-medium text-slate-700 dark:text-slate-300">
              <div className="w-1.5 h-1.5 rounded-full bg-purple-400" /> Power
              Bank & Cables
            </li>
          </ul>
        </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            {
              icon: <Tent className="w-4 h-4 text-green-500" />,
              label: "Camping Zone",
            },
            {
            ...
            {
              icon: <Mic2 className="w-4 h-4 text-purple-500" />,
              label: "Meet & Greet",
            },
          ].map((item, i) => (
            <div
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="#" className="font-bold text-[#FF5E1F] hover:underline">
            View Gallery
          </Link>
        </div>
          ...
          {[1, 2, 3].map((r) => (
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-3">
                "Best weekend of my life! The sound system was incredible and
                the crowd was pure energy. Can't wait for next year."
              </p>
            </div>
          ))}
        </div>
