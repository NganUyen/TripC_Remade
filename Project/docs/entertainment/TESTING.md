...
describe('Health Check API', () => {
  ...
  it('should check entertainment database connectivity', async () => {
    ...
    expect(data.performance.entertainment_db_response_time_ms).toBeGreaterThan(0);
  });
});
```
...
describe('GET /api/entertainment', () => {
  ...
  it('should filter by type', async () => {
    const response = await fetch('http://localhost:3000/api/entertainment?type=tour');
    const data = await response.json();
  ...
  it('should search by query string', async () => {
    const response = await fetch('http://localhost:3000/api/entertainment?q=Paris');
    const data = await response.json();
    ...
    const hasParisInResults = data.data.some((item: any) => 
  ...
  it('should support pagination', async () => {
    const response = await fetch('http://localhost:3000/api/entertainment?limit=2&offset=0');
    const data = await response.json();
...
describe('GET /api/entertainment/:id', () => {
  ...
  beforeAll(async () => {
    ...
    const response = await fetch('http://localhost:3000/api/entertainment?limit=1');
    const data = await response.json();
    testItemId = data.data[0]?.id;
  });

  it('should return a single entertainment item', async () => {
    const response = await fetch(`http://localhost:3000/api/entertainment/${testItemId}`);
    const data = await response.json();
  ...
  it('should return 404 for non-existent item', async () => {
    ...
    const response = await fetch(`http://localhost:3000/api/entertainment/${fakeId}`);
  ...
  it('should validate UUID format', async () => {
    ...
    const response = await fetch(`http://localhost:3000/api/entertainment/${invalidId}`);
...
describe('DELETE /api/entertainment/:id', () => {
  ...
  it.skip('should delete an entertainment item', async () => {
    ...
    const createResponse = await fetch('http://localhost:3000/api/entertainment', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${mockAuthToken}`,
    ...
    // Now delete it
    const deleteResponse = await fetch(`http://localhost:3000/api/entertainment/${itemId}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${mockAuthToken}`,
      },
    ...
    // Verify it's deleted
    const getResponse = await fetch(`http://localhost:3000/api/entertainment/${itemId}`);
